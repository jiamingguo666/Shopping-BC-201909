...
/**
 * @Description: 管理员修改普通商品信息
 * @Author: jiaming.guo
 * @Date: 2019/8/19 16:34
 */
@WebServlet("/adminUpdateGoodsServlet")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (FileItem item : list) {
            ...
            if (item.isFormField()) {
                ...
                String id  = (String) session.getAttribute("goodsId");
                ...
                if (fileName == null || "".equals(fileName.trim())) {
                    if (GoodsDao.updateGoodsExceptPicture(name,city,goodsPrice,memberPrice,discountPrice,goodsNumber,goodsId)) {
                    ...
                    if (fileName == null || "".equals(fileName.trim())) {
                        ...
                        if (GoodsDao.updateGoods(name,city,goodsPrice,memberPrice,discountPrice,goodsNumber,goodsId,picture)) {
                            request.getRequestDispatcher("/jsp/admin/homePage.jsp").forward(request, response);
                        } else {
                            request.getRequestDispatcher("/jsp/admin/updategoods.jsp").forward(request, response);
                        }
