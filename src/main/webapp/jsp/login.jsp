...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form action="/demo9/login" method="post" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                    ...
                    <section class="content">
                        ...
                        <span align="center" colspan="5" style="color: red">
                             <%  Integer  flag = (Integer) session.getAttribute("flag");
                                 ...
                                 if(flag == 1 && errorMessage!= null  && !"".equals(errorMessage)){
                             %>
                                 <td ><% out.print(errorMessage);
                                 %></td>

                            <%
                               }else if(flag == 2 && message != null &&!"".equals(message)){
                            %>
                        ...
                        <span class="form-actions" align="center" colspan="5" >
                            ...
                            <a tabindex="5" class="btn btn-link text-muted" onClick="goto_register()"href="/demo9/jsp/registe.jsp">注册</a>
                        </span>
                    </section>
                </div>
            </form>
