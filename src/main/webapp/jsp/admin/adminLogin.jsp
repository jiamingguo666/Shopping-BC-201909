...
<div class="login-box">
    <h1>商城管理员登录</h1>
    <form method="post" action="/demo9/adminLoginServlet">
        <div class="adminName">
            <label>账  号：</label>
            ...
            %>
                             <%  Integer  adminFlag = (Integer) session.getAttribute("adminFlag");
                                 if(adminFlag != null){
                                     ...
                                     if(adminFlag == 1 && errorMessage!= null  && !"".equals(errorMessage)){
                             %>
                                 <td ><% out.print(errorMessage);
                                 %></td>

                            <%
                            }else if(adminFlag == 2 && message != null &&!"".equals(message)){
                            %>
        ...
        <div class="login" align="center">
            ...
            <a tabindex="5" class="btn btn-link text-muted" onClick="goto_register()"href="/demo9/jsp/admin/adminRegiste.jsp">注册</a>
