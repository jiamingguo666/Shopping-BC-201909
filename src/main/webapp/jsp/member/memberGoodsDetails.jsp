    ...
    <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <td width="70%" valign="top">
                <table>
                    <tr>
                        <td rowspan="7"><img src="/demo9/MemberShowImgServlet?imgPath=<%=goods.getPicture() %>" width="200" height="200"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>原价：<%=goods.getPrice() %></td>
                    </tr>
                    <tr>
                        <td>会员价：<%=goods.getMemberPrice() %></td>
                    </tr>
                    <tr>
                        <td>优惠价：<%=goods.getDiscountPrice() %></td>
                    </tr>
                    <tr>
                        <td colspan="5" align="center">
                            <a href="/demo9/jsp/member/memberGoodsShow.jsp">返回</a>
                            <a href="/demo9/memberOneGoodsServlet?id=<%=goods.getId()%>">加入购物车</a>
